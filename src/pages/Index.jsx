...
const handleLogin = () => {
  if (!document.getElementById('username').value) setUsernameError('Username is required');
  else setUsernameError('');
  if (!document.getElementById('password').value) setPasswordError('Password is required');
